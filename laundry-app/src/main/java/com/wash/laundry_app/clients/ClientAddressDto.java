...
public class ClientAddressDto {
    ...
    @jakarta.validation.constraints.Pattern(regexp = "^[a-zA-ZÀ-ÿ\\u0600-\\u06FF0-9\\s\\-.,'()]+$", message = "Adresse contient des caractères non valides")
    private String address;
    private BigDecimal latitude;
    private BigDecimal longitude;

    @jakarta.validation.constraints.Size(max = 1000, message = "Les notes ne doivent pas dépasser 1000 caractères")
    @jakarta.validation.constraints.Pattern(regexp = "^[a-zA-ZÀ-ÿ\\u0600-\\u06FF0-9\\s\\-.,'()!?+]*$", message = "Les notes contiennent des caractères non valides")

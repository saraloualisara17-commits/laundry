    ...
    <div className="min-h-screen bg-[#f5f5f7]" dir="ltr">
      ...
      <div className="max-w-3xl mx-auto px-5 md:px-10 -mt-4 mb-10">
        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          ...
          {/* Right: receipt card */}
          <div className="w-full sm:w-52 flex-shrink-0 bg-[#1a2e44] rounded-2xl p-6 flex flex-col items-center justify-center gap-3 text-center">
      ...
      {/* ── Action buttons ── */}
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 px-6 mb-16">
        <a href={`https://wa.me/${WHATSAPP.replace('+', '')}?text=${encodeURIComponent(`Bonjour, ma commande est #${orderNumber}`)}`}
          ...
          className="flex items-center justify-center gap-2.5 bg-[#25D366] text-white
                     w-full sm:w-auto px-6 py-3.5 rounded-full font-bold text-sm shadow-lg shadow-green-200
        ...
        <button onClick={onNewOrder}
          className="flex items-center justify-center gap-2.5 bg-[#1a2e44] text-white
                     w-full sm:w-auto px-6 py-3.5 rounded-full font-bold text-sm shadow-lg shadow-slate-900/20

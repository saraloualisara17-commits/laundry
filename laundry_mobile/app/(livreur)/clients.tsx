...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { fontSize: 14, color: AdminColors.textMuted, fontWeight: '500' },
  searchContainer: {
    marginHorizontal: 16, marginBottom: 12, backgroundColor: AdminColors.surface2,
    borderRadius: 14, height: 48, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, gap: 10,
  },
  ...
  clientCard: {
    ...
    flexDirection: 'row', alignItems: 'center', gap: 14, ...AdminShadows.shadowSmall,
  },
  avatar: { width: 52, height: 52, borderRadius: 26, backgroundColor: AdminColors.primary, alignItems: 'center', justifyContent: 'center' },
  avatarText: { fontSize: 20, fontWeight: '700', color: 'white' },
  infoCol: { flex: 1 },
  clientName: { fontSize: 16, fontWeight: '700', color: AdminColors.textPrimary },
  clientPhone: { fontSize: 13, color: AdminColors.textSecondary, marginTop: 2, fontWeight: '500' },
  clientAddress: { fontSize: 12, color: AdminColors.textMuted, marginTop: 2 },
  ...
  countBadgeText: { color: AdminColors.primary, fontSize: 11, fontWeight: '600' },
});

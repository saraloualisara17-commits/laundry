      ...
      <View style={styles.overlay}>
        ...
        <View style={[styles.sheet, { height: '82%' }]}>
          ...
          <View style={[styles.headerRow, row(isArabic)]}>
            <View style={styles.iconBadge}><Feather name="truck" size={20} color={Colors.primary} /></View>
            <View style={{ flex: 1 }}>
              <Text style={[styles.title, isArabic && { textAlign: 'right' }]}>{t('admin.orders.assign_driver')}</Text>
          ...
          <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
            <View style={styles.body}>
              ...
              {!driversLoading && driversError && (
                <Text style={{ color: Colors.danger, textAlign: 'center', padding: 16 }}>{t('common.error_msg')}</Text>
              )}
...
const styles = StyleSheet.create({
  ...
  confirmBtn: { height: 50, borderRadius: 14, backgroundColor: Colors.primary, alignItems: 'center', justifyContent: 'center' },
